...
public interface TStockReposiotory extends JpaRepository<TStockQuoteYahooEntity, demo.com.sb_final_project.entity.TStockQuoteYahooEntityPK>{
  ...
  @Query(value = "SELECT NEW demo.com.sb_final_project.model.dto.SystemDate(symbol, MAX(APIDatetime)) FROM TStockQuoteYahooEntity WHERE symbol = :symbol GROUP BY symbol")
  SystemDate findMaxMarketTimeBySymbol(@Param("symbol") String symbol);
